...
Public Class frmgl_enter
    ...
    Private Sub cmdUpdate_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdUpdate.Click
        ...
        If entry_type = "ADD" Then
            If checkYN("chacct", "acct_num", acct_num.Text) = "Y" Then
                MsgBox("Account exists in the Chart of Accounts.  Not added again.")
                acct_num.Focus()
                Exit Sub
            End If
        End If
        ...
        Select Case entry_type.ToString
            Case "ADD"
                ...
                selected_acct_num = acct_num.Text
            Case "EDIT"
