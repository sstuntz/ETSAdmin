...
Public Class frmbt_160
    ...
    Private Sub frmbt_160_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        If Val(txtfields(15).Text) <> 0 Then
            txtfields(17).Text = ETSSQL.GetProgRate(selected_contract_key, txtfields(15).Text).ToString
        ...
        _txtfields_19.AutoCompleteCustomSource = ETS.Common.Module1.AutoAcctNums
        _txtfields_19.AutoCompleteSource = AutoCompleteSource.CustomSource
        _txtfields_19.AutoCompleteMode = AutoCompleteMode.SuggestAppend

        _txtfields_20.AutoCompleteCustomSource = ETS.Common.Module1.AutoAcctNums
        _txtfields_20.AutoCompleteSource = AutoCompleteSource.CustomSource
        _txtfields_20.AutoCompleteMode = AutoCompleteMode.SuggestAppend
            ...
            Select Case Index
                ...
                Case 6, 7, 30, 31
                    ...
                    If Not IsNumeric(txtfields(Index).Text) Then
                        ...
                        GoTo EventExitSub
                    Else
                        txtfields(Index).Text = String.Format("{0:F}", Val(txtfields(Index).Text)) 'ets_format(txtfields(Index).Text, "", 3, "")
                    End If

                    If Val(txtfields(17).Text) <> 0 Then
                        If Index = 6 Then
                            Dim pct As String = CStr(Val(txtfields(6).Text) / Val(txtfields(17).Text))
                            Text8.Text = String.Format(pct, "C")
                        End If
                ...
                Case 15
                    ...
                    sqlstmnt = "Select * from program where prog_num = '" & txtfields(15).Text & "' and fiscal_yr = " & Year(CDate(txtfields(13).Text))
