...
Friend Class frmbt_125
    ...
    Private Sub frmbt_125_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub txtFields_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles txtFields.KeyPress
        ...
        If KeyAscii = 13 Or KeyAscii = 9 Then
            ...
            Select Case Index
                ...
                Case 10, 11, 14, 15, 16, 17, 18, 19, 20
                    ...
                    If selected_bill_type = "125" Then
                        If Not IsNumeric(txtfields(Index).Text) Then
                            ...
                            Call ets_set_selected()
                            GoTo EventExitSub
                        Else : txtfields(Index).Text = CStr(txtfields(Index).Text)
                        End If
                    End If
