...
Namespace PS.Common
    ...
    Public Class Database
        ...
        Private stmts As List(Of SqlCommand)
        Private rsets As List(Of SqlDataReader)
        Private dsets As List(Of DataSet)
        ...
        Public Sub New(ByVal connectionString As String, ByVal transacted As Boolean, ByVal isoLevel As System.Data.IsolationLevel)
            ...
            Me.conn = Nothing
            Me.tran = Nothing
            Me.stmts = New List(Of SqlCommand)()
            Me.rsets = New List(Of SqlDataReader)()
            Me.dsets = New List(Of DataSet)()
        ...
        Public Function RunProcedure(ByVal procName As String, ByVal params As SqlParameter()) As Integer
            If Me.amDisposed Then
                Throw New ObjectDisposedException("Database")
            End If
            Using stmt As SqlCommand = CreateCommand(procName, params)
        ...
        Public Function ExecuteQuery(ByVal sql As String, Optional ByVal timeout As Integer = -1) As SqlDataReader
            If Me.amDisposed Then
                Throw New ObjectDisposedException("Database")
            End If
            Dim stmt As SqlCommand = New SqlCommand(sql, Me.conn, Me.tran)
        ...
        Public Function FillDataSet(ByVal sql As String) As DataSet
            If Me.amDisposed Then
                Throw New ObjectDisposedException("Database")
            End If
            Using adr As SqlDataAdapter = New SqlDataAdapter(sql, Me.conn)
