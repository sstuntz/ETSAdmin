...
Public Class apmvreg
    ...
    Private Sub Command1_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command1.Click
        ...
        prtreportfilename = ap_report_path & "apvreg.rpt"
        CrystalForm.ShowDialog()
    End Sub

    Private Sub apmvreg_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        'data 1 = etssys
    End Sub
