...
Public Class apvchgl_frm
    ...
    Private Sub cmdPost_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles CmdPost.Click
        ...
        sqlstmnt = "select * from voucher WHERE voucher.glpost = 'N' and voucher.dflag = 'N' and voucher.void = 'N'"
        sqlstmnt = sqlstmnt & " and voucher.encum_date between "
        sqlstmnt = sqlstmnt & Chr(35) & txtField0(0).Text & Chr(35) & " and "
        sqlstmnt = sqlstmnt & Chr(35) & txtField1(1).Text & Chr(35) & " order by vouch_num "
        ...
        '         voucher.Recordset.edit
        '         voucher.Recordset.Fields("jrnl_num") = Val(Text1) + 1
        '         voucher.Recordset.Fields("glpost") = "Y"
        '         voucher.Recordset.Update
        '         voucher.Recordset.MoveNext
        '         Loop
        '
        '  ' MsgBox " Fix me: the glpost = Y is not set yet!"
        '   Command2.SetFocus
    ...
    Private Sub Command2_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command2.Click
        prtDestination = 1
        prtreportfilename = ap_report_path & "apvcjrnl.rpt"
        CrystalForm.ShowDialog()
    End Sub

    Private Sub Command3_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command3.Click
        prtDestination = 0
        prtreportfilename = ap_report_path & "apjetmpv.rpt"
        CrystalForm.ShowDialog()
    End Sub
    ...
    Private Sub CmdPrepareJE_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles CmdPrepareJE.Click
        ...
        Dim VoucherJE As New List(Of JeData)
        Dim DRAcctTot As New List(Of AcctNums)
        Dim CRAcctTot As New List(Of AcctNums)
        Dim JeRowData As New List(Of JeData)

        sqlstmnt = "SELECT dr_acct_nu as AcctNum, SUM(alloc_amt) AS acct_1"
        sqlstmnt = sqlstmnt & " FROM voucher where (glpost = 'N') AND (dflag = 'N') AND (void = 'N') AND (encum_date between '"
    ...
    Private Sub apvchgl_frm_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
