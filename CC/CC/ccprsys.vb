...
Friend Class frmccprsys
    ...
    Public frmWhereClause As String = "Agency = 1"
    ...
    Private Sub frmccprsys_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        For Each Me.cntrl In Me.Controls
            If TypeOf cntrl Is ComboBox Then
                For ETSCommon.MODULE1.num1 = 0 To 7
                    cmbox = CType(cntrl, ComboBox)
                    cmbox.Items.Add(sort_array(num1))
                Next
                'put the right text into the combobox
                num1 = CInt(cmbox.Name.ToString.Substring(8)) + 9       'column number
                For ETSCommon.MODULE1.num = 0 To 7
                    If sort_array(num) = RowData.Item(num1).ActualData Then
                        cmbox.SelectedIndex = num
                    End If
                Next
            End If
        Next
