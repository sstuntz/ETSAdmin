...
Public Class prep_je_cc
    Inherits System.Windows.Forms.Form

    Public valid_acct_flg As String
    Dim beg_chk_num As Integer
    Dim last_Chk_num As Integer
    ...
    Private Sub pr_num1_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles PayrollNumber.KeyPress
        ...
        If KeyAscii = 13 Or KeyAscii = 9 Then
            ...
            If InStr(1, PayrollNumber.Text, ",") > 0 Then
                beg_chk_num = CInt(VB.Left(PayrollNumber.Text, InStr(1, PayrollNumber.Text, ",") - 1))
                last_Chk_num = CInt(VB.Right(PayrollNumber.Text, Len(PayrollNumber.Text) - InStr(1, PayrollNumber.Text, ",")))
            Else
                beg_chk_num = CInt(PayrollNumber.Text)
    ...
    Private Sub Process_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Process.Click
        ...
        '1 zero je tmp
        '2 collect all data from ccjob,cc_deduct,ccckstub and move to je_tmp
        ...
        sqlstmnt = "delete from je_tmp"
        ETSSQL.ExecuteSQL(sqlstmnt)
      
        'now we read ccckstub for this pay period and get the liability

        sqlstmnt = "select * from ccckstub where pay_num = '" & PayrollNumber.Text & "' and void <> 'Y' and dflag = 'N' and gl_post = 'N'"
        saved_Date = CDate(ETSCommon.GetDatum("ccckstub", "pay_num", PayrollNumber.Text, "chk_date"))   'ccckstub.Recordset.Fields("chk_Date").Value
        ...
        sqlstmnt = "select * from cctime where pay_num = '" & PayrollNumber.Text & "' and void <> 'Y' and dflag = 'N' and gl_post = 'N' and pay_dol > 0 order by dept_num, job_num "
