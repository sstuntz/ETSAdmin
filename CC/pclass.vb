...
Public Class frmpclass
    Inherits System.Windows.Forms.Form

    Public ds(50, 50, 50) As String
    Public TagColumnName As String
    Public frmTableName As String = "cc_paycl"
    Public frmWhereClause As String = " where pay_class = '" & selected_lookup_num & "'"
    ...
    Private Sub frmpclass_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ctrform(Me)
        frmWhereClause = " where pay_Class = '" & selected_lookup_num & "'"
