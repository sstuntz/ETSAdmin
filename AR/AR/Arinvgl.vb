...
Friend Class arinvgl_frm
	...
	Private Sub Command1_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command1.Click 'lhw 3/26/97
		...
		On Error GoTo 0 'changed 9-14-00 lhw
		...
		je_tmp.recordsource = "select * from je_tmp order by je_tmp.type, je_tmp.acct_num"
		je_tmp.Refresh()
		...
		Do While Not je_tmp.Recordset.EOF
			...
			Else
				If tot_amt <> 0 Then
					...
					'UPGRADE_ISSUE: Data property yrgenled.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
					yrgenled.Recordset.Fields("jrnl_desc").Value = "AR Invoices"
					'UPGRADE_ISSUE: Data property yrgenled.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
		...
		'7a  update glpost flag and put je num in each invoice record
		
		sqlstmt = "select * from invoice WHERE invoice.glpost <> 'Y' and invoice.void = 'N' "
		sqlstmt = sqlstmt & " and invoice.encum_date between "
		...
		Do While Not invoice.Recordset.EOF
			...
			'UPGRADE_ISSUE: Data property invoice.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			invoice.Recordset.Fields("jrnl_num").Value = Val(Text1.Text) + 1
			'UPGRADE_ISSUE: Data property invoice.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
		...
		MsgBox("J/E Complete!!! Print the J/E now.") 'Fix me: the glpost = Y is not set yet!"
	...
	Private Sub Command2_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command2.Click
		...
		prtreportfilename = ar_report_path & "arinvjrnl.rpt"
	...
	Private Sub Command3_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command3.Click
		...
		prtreportfilename = ar_report_path & "arjetmpi.rpt"
		' Call frmcrystal_Call
	End Sub
	...
	Private Sub Command4_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command4.Click
		...
		'2 this takes dr_acct_nu from invoice and moves it to je_tmp
		'3 this takes cr_acct_nu from invoice and moves it to je_tmp
		...
		'7a update glpost and put je num in each invoice in set
		...
		'2 invoice data control on form
		'******create the debit amount to je tmp
		sqlstmt = "select * from invoice WHERE invoice.void = 'N'"
		sqlstmt = sqlstmt & " and invoice.glpost <> 'Y'"
		sqlstmt = sqlstmt & " and invoice.encum_date between "
		sqlstmt = sqlstmt & Chr(35) & txtField0(0).Text & Chr(35) & " and "
		sqlstmt = sqlstmt & Chr(35) & txtField1(1).Text & Chr(35) & " order by invoice.dr_acct_nu "
		...
		Do While Not invoice.Recordset.EOF
			...
			'UPGRADE_ISSUE: Data property je_tmp.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			'UPGRADE_ISSUE: Data property invoice.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			je_tmp.Recordset.Fields("acct_num").Value = invoice.Recordset.Fields("dr_acct_nu").Value
			'UPGRADE_ISSUE: Data property je_tmp.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			'UPGRADE_ISSUE: Data property invoice.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			je_tmp.Recordset.Fields("dol_amt").Value = invoice.Recordset.Fields("alloc_amt").Value
			'UPGRADE_ISSUE: Data property je_tmp.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			'UPGRADE_ISSUE: Data property invoice.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			je_tmp.Recordset.Fields("inv_num").Value = invoice.Recordset.Fields("inv_num").Value
			'UPGRADE_ISSUE: Data property je_tmp.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			'UPGRADE_ISSUE: Data property invoice.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			je_tmp.Recordset.Fields("line_num").Value = invoice.Recordset.Fields("line_num").Value
			'UPGRADE_ISSUE: Data property je_tmp.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			'UPGRADE_ISSUE: Data property invoice.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			je_tmp.Recordset.Fields("inv_date").Value = invoice.Recordset.Fields("invoice_date").Value
			'UPGRADE_ISSUE: Data property je_tmp.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			je_tmp.Recordset.Fields("end_date").Value = txtField1(1).Text
			'UPGRADE_ISSUE: Data property je_tmp.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			je_tmp.Recordset.Fields("type").Value = "1" 'debit
			'UPGRADE_ISSUE: Data property je_tmp.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
		...
		'******create the credit amount to je tmp
		sqlstmt = "select * from invoice WHERE invoice.void = 'N'"
		sqlstmt = sqlstmt & " and invoice.glpost <> 'Y' "
		sqlstmt = sqlstmt & " and invoice.encum_date between "
		sqlstmt = sqlstmt & Chr(35) & txtField0(0).Text & Chr(35) & " and "
		sqlstmt = sqlstmt & Chr(35) & txtField1(1).Text & Chr(35) & " order by invoice.cr_acct_nu "
		...
		Do While Not invoice.Recordset.EOF
			...
			'UPGRADE_ISSUE: Data property je_tmp.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			'UPGRADE_ISSUE: Data property invoice.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			je_tmp.Recordset.Fields("acct_num").Value = invoice.Recordset.Fields("cr_acct_nu").Value
			'UPGRADE_ISSUE: Data property je_tmp.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			'UPGRADE_ISSUE: Data property invoice.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			je_tmp.Recordset.Fields("dol_amt").Value = invoice.Recordset.Fields("alloc_amt").Value * -1
			'UPGRADE_ISSUE: Data property je_tmp.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			'UPGRADE_ISSUE: Data property invoice.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			je_tmp.Recordset.Fields("inv_num").Value = invoice.Recordset.Fields("inv_num").Value
			'UPGRADE_ISSUE: Data property je_tmp.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			...
			je_tmp.Recordset.Fields("end_date").Value = txtField1(1).Text
			'UPGRADE_ISSUE: Data property je_tmp.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			je_tmp.Recordset.Fields("type").Value = "2" 'credit
			'UPGRADE_ISSUE: Data property je_tmp.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			je_tmp.Recordset.update()
			'UPGRADE_ISSUE: Data property invoice.Recordset was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="076C26E5-B7A9-4E77-B69C-B4448DF39E58"'
			invoice.Recordset.MoveNext()
	...
	Private Sub arinvgl_frm_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		' data1 = etssys
		On Error Resume Next
