...
Public Class arinv
    ...
    Private Sub SaveAdd_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles SaveAdd.Click
        ...
        txtFields(12).Text = CStr(Today)
        txtFields(13).Text = CStr(Today)
        ...
        TextBox3.Text = "1/" & Month(CDate(txtFields(14).Text)) & "/" & Year(CDate(txtFields(14).Text))
    ...
    Private Sub frmarinv_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        txtFields(11).Text = String.Format("{0:F2}", txtFields(11).Text)
            ...
            Select Case Index
                ...
                Case 11, 30, 20, 21 'format the dollar fields
                    ...
                    If Len(txtFields(Index).Text) = 0 Then
                        ...
                        GoTo EventExitSub
                    End If
                    txtFields(Index).Text = String.Format("{0:F2}", txtFields(Index).Text)
                ...
                Case 2
                    ...
                    Select Case txtFields(Index).Text
                        Case "CM", "DM" 'credit or debit memo not checking amt for sign
                            'fill todays dates
                            txtFields(13).Text = CStr(Today)
                            txtFields(14).Text = CStr(Today)
                            txtFields(15).Text = CStr(Today)
                ...
                Case 9, 10 'gl acct number lookup
