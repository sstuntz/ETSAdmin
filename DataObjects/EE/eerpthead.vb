...
Public ReadOnly Property rptheadColumnNames() as string
		Get 
	              	              	              return "([agency] , [BEG_DATE] , [END_DATE] , [BEG_NUM] , [END_NUM] , [CURR_MNTH] , [BUD_MNTH] , [CHECK_DATE] , [ENTRY_DATE] , [NAME_KEY] , [APRECON_DATE] , [SPRECON_DATE] , [CLRECON_DATE] , [MIN_DATE] , [beg_dept] , [end_dept] , [eff_date] )"
		End Get
End Property
