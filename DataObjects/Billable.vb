...
Public Class Billable
    ...
    Implements IEquatable(Of Billable)
    ...
    'Public Function EqualsContract(ByVal other As Billable) As Boolean Implements IEquatable(Of Billable).Equals
    '    If other Is Nothing Then Return False
    '    If Me Is other Then Return True
    '    Return BNum.Equals(other.BNum) AndAlso BillType.Equals(other.BillType)
    'End Function
    ...
    Public Overrides Function GetHashCode() As Integer
        Dim hashBillableBillType = If(BillType Is Nothing, 0, BillType.GetHashCode)
        Return hashBillableBillType
    End Function
