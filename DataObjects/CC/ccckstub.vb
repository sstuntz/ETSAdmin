...
Public ReadOnly Property ccckstubColumnNames() as string
		Get 
	              	              	              return "([chk_num] , [chk_date] , [chk_dirdep] , [pay_num] , [name_key] , [screen_nam] , [sort_name] , [desc1] , [desc2] , [desc3] , [dept_num] , [fund_code] , [disab_num] , [pay_freq] , [ded_dfq] , [fwt_exmts] , [swt_exmts] , [blend_ovt] , [dir_hrs] , [dir_dol] , [ind_hrs] , [ind_dol] , [no_pay_hrs] , [vac_hrs] , [vac_dol] , [sick_hrs] , [sick_dol] , [hol_hrs] , [hol_dol] , [pers_hrs] , [pers_dol] , [makeup] , [stipend] , [minimum] , [full_gross] , [fed_gross] , [fed_tax] , [fica_gross] , [fica_tax] , [med_gross] , [med_tax] , [state1_gross] , [state1_tax] , [state2_gross] , [state2_tax] , [net_pay] , [dduct1_dol] , [dduct1_num] , [dduct2_dol] , [dduct2_num] , [dduct3_dol] , [dduct3_num] , [dduct4_dol] , [dduct4_num] , [gl_post] , [encum_date] , [recon] , [r_date] , [void] , [agency] , [dflag] , [add_fwt] , [add_swt] , [add_fica] , [add_med] , [state1_code] , [state2_code] , [entry_num] , [tdi_Tax] , [jrnl_num] , [jrnl_line] )"
		End Get
End Property
