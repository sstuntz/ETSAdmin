...
Public ReadOnly Property ccvacColumnNames() as string
		Get 
	              	              	              return "([NameKey] , [ScreenNam] , [SortName] , [Code1Num] , [Code2Num] , [VAccrual] , [HAccrual] , [SAccrual] , [PAccrual] , [Months] , [HrsWeek] , [VbegDate] , [HbegDate] , [SbegDate] , [PbegDate] , [MaxVac] , [UsedVac] , [RemVac] , [LimitVac] , [MaxHol] , [UsedHol] , [RemHol] , [LimitHol] , [MaxSick] , [UsedSick] , [RemSick] , [LimitSick] , [MaxPers] , [UsedPers] , [RemPers] , [LimitPers] , [Agency] , [AccrualCnt] , [AccElig] )"
		End Get
End Property

Public ReadOnly Property ccvacColumnData() as string
		Get 
