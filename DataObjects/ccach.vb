...
Public Property COr-s()  as String
	Get
		Return _COr-s
	End Get
	Set (ByVal value  as String )
...
Public ReadOnly Property ccachColumnNames() as string
		Get 
	              	              	              return "([NameKey] , [ScreenNam] , [ErNum] , [ErNam] , [EmployNum] , [Name] , [PayDate] , [BnkabaNum] , [BnkacctNum] , [COr-s] , [$amt] )"
		End Get
End Property

Public ReadOnly Property ccachColumnData() as string
		Get 
