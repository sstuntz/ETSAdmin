...
Public Class BillableContract

    Implements IEquatable(Of BillableContract)
    ...
    'Public Function EqualsClient(ByVal other As Billable) As Boolean Implements IEquatable(Of Billable).Equals
    '    If other Is Nothing Then Return False
    '    If Me Is other Then Return True
    '    Return BNum.Equals(other.BNum) AndAlso BillType.Equals(other.BillType)
    'End Function

    Public Function EqualsContract(ByVal other As BillableContract) As Boolean Implements IEquatable(Of BillableContract).Equals
        If other Is Nothing Then Return False
        If Me Is other Then Return True
        Return ContractKey.Equals(other.ContractKey)
    End Function

    Public Overrides Function GetHashCode() As Integer
        Dim hashBillableContractkey = If(ContractKey Is Nothing, 0, ContractKey.GetHashCode)
        Return hashBillableContractkey
    End Function
