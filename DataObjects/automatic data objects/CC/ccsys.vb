...
Public ReadOnly Property ccsysColumnNames() as string
		Get 
	              	              	              return "([Agency] , [AgencyName] , [ErFedId] , [ErStId] , [PayFreq] , [MinWage] , [MinCkAmt] , [MakeupRate] , [TaxMakeup] , [CcSort1] , [CcSort2] , [CcSort3] , [CcSort4] , [CcSort5] , [CcSort6] , [TdiPct] , [TaxMinimum] , [TaxStipend] , [MinCkDfq] , [Fiscal] )"
		End Get
End Property
