...
Public ReadOnly Property CCTimeColumnNames() as string
		Get 
	              	              	              return "([EntryDate] , [PayNum] , [NameKey] , [ScreenNam] , [SortName] , [PayFreq] , [DedDfq] , [EntryNum] , [LineNum] , [Date] , [JobNum] , [PayClass] , [Hours] , [PcsProd] , [DeptNum] , [PayDol] , [ClPct] , [ChkNum] , [Refusal] , [Paid] , [Checked] , [Dflag] , [Agency] , [Void] , [Glpost] , [EncumDate] , [StateTax] , [JrnlNum] , [JrnlLine] )"
		End Get
End Property
...
, (_LineNum.ToString) _
, Database.StringParam(_WorkDate.ToShortDateString) _
